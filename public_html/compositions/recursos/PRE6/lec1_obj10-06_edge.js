...
(function (compId) {
                    ...
                    dom: [
                        {
                            id: 'cont_1',
                            type: 'rect',
                            rect: ['0px', '307px', '1830px', '473px', 'auto', 'auto'],
                            ...
                            c: [
                            {
                                ...
                                type: 'rect',
                                rect: ['315px', '60px', 'undefined', 'undefined', 'auto', 'auto'],
                                cursor: 'pointer',
                            ...
                            },
                            {
                                id: 'texto_2',
                                type: 'text',
                                rect: ['759px', '42px', '441px', '160px', 'auto', 'auto'],
                                text: "<p style=\"margin: 0px;\">​V, t, n.</p><p style=\"margin: 0px;\">F, t, n.</p><p style=\"margin: 0px;\">V, t, m.</p><p style=\"margin: 0px;\">D, t, n.</p><p style=\"margin:0px\"></p>",
                                align: "left",
                            ...
                            },
                            {
                                ...
                                symbolName: 'PICK_1',
                                type: 'rect',
                                rect: ['730px', '57px', 'undefined', 'undefined', 'auto', 'auto'],
                                cursor: 'pointer'
                            },
                            {
                                id: 'PICK_2',
                                symbolName: 'PICK_2',
                                type: 'rect',
                                rect: ['730px', '94px', 'undefined', 'undefined', 'auto', 'auto'],
                                cursor: 'pointer'
                            },
                            {
                                id: 'PICK_3',
                                symbolName: 'PICK_3',
                                type: 'rect',
                                rect: ['730px', '135px', 'undefined', 'undefined', 'auto', 'auto'],
                                cursor: 'pointer'
                            },
                            {
                                id: 'PICK_4',
                                symbolName: 'PICK_4',
                                type: 'rect',
                                rect: ['730px', '177px', 'undefined', 'undefined', 'auto', 'auto'],
                                cursor: 'pointer'
                            }]
                        },
                        {
                            ...
                            type: 'text',
                            rect: ['104px', '76px', '1658px', '204px', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px; line-height: 40px;\">​<span style=\"color: rgb(106, 55, 137); font-family: sena_icon; font-size: 30px;\">Z</span><span style=\"font-size: 30px;\">&nbsp;Consonante, vocal</span></p><p style=\"margin: 0px; font-family: source-sans-pro, sans-serif; font-weight: 400; font-style: normal; text-decoration: none; font-size: 30px; color: rgb(51, 51, 51); background-color: rgba(0, 0, 0, 0); letter-spacing: 0px; text-transform: none; word-spacing: 0px; text-align: left; text-indent: 0px; line-height: 40px;\"><span style=\"font-weight: 900; color: rgb(106, 55, 137); font-size: 30px;\">6</span><span style=\"font-size: 30px;\">&nbsp;</span>Identifique las consonantes de la palabra que se menciona en el audio</p><p style=\"margin:0px\">​</p><p style=\"margin: 0px; font-family: source-sans-pro, sans-serif; font-weight: 400; font-style: normal; text-decoration: none; font-size: 30px; color: rgb(51, 51, 51); background-color: rgba(0, 0, 0, 0); letter-spacing: 0px; text-transform: none; word-spacing: 0px; text-align: left; text-indent: 0px; line-height: 40px;\"><span style=\"font-size: 30px;\"></span></p><p style=\"margin: 0px; font-family: source-sans-pro, sans-serif; font-weight: 400; font-style: normal; text-decoration: none; font-size: 30px; color: rgb(51, 51, 51); background-color: rgba(0, 0, 0, 0); letter-spacing: 0px; text-transform: none; word-spacing: 0px; text-align: left; text-indent: 0px; line-height: 40px;\"><span style=\"font-size: 30px;\">​</span><span style=\"font-style: italic;\">Instrucción: escuche el audio y seleccione la opción de respuesta que contenga las consonantes de la palabra mencionada en el audio. Tiene distractores.</span></p><p style=\"margin: 0px; font-family: source-sans-pro, sans-serif; font-weight: 400; font-style: normal; text-decoration: none; font-size: 30px; color: rgb(51, 51, 51); background-color: rgba(0, 0, 0, 0); letter-spacing: 0px; text-transform: none; word-spacing: 0px; text-align: left; text-indent: 0px; line-height: 40px;\"><span style=\"font-style: italic;\"></span></p><p style=\"margin: 0px; font-family: source-sans-pro, sans-serif; font-weight: 400; font-style: italic; text-decoration: none; font-size: 30px; color: rgb(51, 51, 51); background-color: rgba(0, 0, 0, 0); letter-spacing: 0px; text-transform: none; word-spacing: 0px; text-align: left; text-indent: 0px; line-height: 40px;\"><span style=\"font-size: 30px;\"></span></p>",
                            align: "left",
                ...
                timeline: {
                    ...
                    data: [
                        ...
                        [
                            ...
                            [ "eid197", "trigger", 124, function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${audiomp3_1}', [] ] ]
                    ]
                }
            },
            "PICK_1": {
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("lec1_obj10-06_edgeActions.js");
})("EDGE-17298671");
