                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'Text2Copy4',
                            type: 'text',
                            rect: ['403px', '247px', '441px', '160px', 'auto', 'auto'],
                        ...
                        },
                        {
                            ...
                            symbolName: 'PICK_1',
                            type: 'rect',
                            rect: ['374px', '262px', 'undefined', 'undefined', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'PICK_2',
                            symbolName: 'PICK_2',
                            type: 'rect',
                            rect: ['374px', '299px', 'undefined', 'undefined', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'PICK_3',
                            symbolName: 'PICK_3',
                            type: 'rect',
                            rect: ['374px', '340px', 'undefined', 'undefined', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'PICK_4',
                            symbolName: 'PICK_4',
                            type: 'rect',
                            rect: ['374px', '382px', 'undefined', 'undefined', 'auto', 'auto'],
                            cursor: 'pointer'
                        }
                    ],
                    style: {
