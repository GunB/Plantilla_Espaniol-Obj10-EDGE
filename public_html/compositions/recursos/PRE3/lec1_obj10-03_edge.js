...
(function (compId) {
                    ...
                    dom: [
                        {
                            ...
                            c: [
                            {
                                ...
                                type: 'rect',
                                rect: ['303px', '55px', 'undefined', 'undefined', 'auto', 'auto'],
                                cursor: 'pointer',
                            ...
                            },
                            {
                                id: 'texto_3',
                                type: 'text',
                                rect: ['753px', '27px', '617px', '160px', 'auto', 'auto'],
                                text: "<p style=\"margin: 0px;\"> </p><p style=\"margin: 0px;\"><span style=\"font-size: 30px;\"></span> </p><p style=\"margin: 0px;\">Be - a - jota - a - ere- o.</p><p style=\"margin: 0px;\">​Te - a - jota - a - ere -a.</p><p style=\"margin: 0px;\">​​Pe - a - jota - a - ere- a.</p><p style=\"margin: 0px;\">​Pe - a - jota - a - ere - o.</p>",
                                align: "left",
                            ...
                            },
                            {
                                ...
                                symbolName: 'PICK_2',
                                type: 'rect',
                                rect: ['724px', '79px', 'undefined', 'undefined', 'auto', 'auto'],
                                cursor: 'pointer'
                            },
                            {
                                id: 'PICK_3',
                                symbolName: 'PICK_3',
                                type: 'rect',
                                rect: ['724px', '120px', 'undefined', 'undefined', 'auto', 'auto'],
                                cursor: 'pointer'
                            },
                            {
                                id: 'PICK_4',
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("lec1_obj10-03_edgeActions.js");
})("EDGE-17298671");
