                    ...
                    dom: [
                        {
                            ...
                            text: "<p style=\"margin: 0px;\">​<span style=\"font-weight: 700; font-size: 30px;\"></span>Escuche los audios y seleccione cuál no corresponde con un sustantivo invariable.</p>",
                            align: "left",
                        ...
                        },
                        {
                            ...
                            symbolName: 'PICK_1',
                            type: 'rect',
                            rect: ['301px', '218px', 'undefined', 'undefined', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'PICK_2',
                            symbolName: 'PICK_2',
                            type: 'rect',
                            rect: ['301px', '275px', 'undefined', 'undefined', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'PICK_3',
                            symbolName: 'PICK_3',
                            type: 'rect',
                            rect: ['301px', '336px', 'undefined', 'undefined', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'PICK_4',
                            symbolName: 'PICK_4',
                            type: 'rect',
                            rect: ['301px', '398px', 'undefined', 'undefined', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'audio_1',
                            symbolName: 'audio_1',
                            type: 'rect',
                            rect: ['467px', '269px', 'undefined', 'undefined', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'audio_2',
                            symbolName: 'audio_2',
                            type: 'rect',
                            rect: ['467px', '212px', 'undefined', 'undefined', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'audio_3',
                            symbolName: 'audio_3',
                            type: 'rect',
                            rect: ['466px', '330px', 'undefined', 'undefined', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'audio_4',
                            symbolName: 'audio_4',
                            type: 'rect',
                            rect: ['467px', '392px', 'undefined', 'undefined', 'auto', 'auto'],
                            cursor: 'pointer'
                        }
                    ],
                    style: {
                ...
                timeline: {
                    ...
                    data: [
                        ...
                        [
                            ...
                            [ "eid203", "trigger", 124, function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${audiomp3_3}', [] ] ]
                    ]
                }
            },
            "audio_4": {
