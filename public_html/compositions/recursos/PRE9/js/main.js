...
{    
    ...
    $.getJSON('config.json', function (json_content) {
        ...
        $('<style type="text/css">.dropdown-menu{ font-size:'+stage.prop('ed_json_property_object').other_css.tamano+'; font-family: '+stage.prop('ed_json_property_object').other_css.fuente+'; letter-spacing: 3px;} .btn{font-size: '+stage.prop('ed_json_property_object').other_css.tamano+'; letter-spacing: 3px; padding-left: 10%}</style>').appendTo("head");
